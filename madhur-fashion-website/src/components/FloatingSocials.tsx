...
export default function FloatingSocials() {
  ...
  return (
    <>
      {/* Floating Instagram (Left Side) */}
      <div className="fixed bottom-6 left-6 z-50 group">
        <a
          href="https://www.instagram.com/madhur_fashions/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-14 h-14 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white rounded-full shadow-lg transition-transform duration-300 hover:scale-110 active:scale-95 focus:outline-none"
        ...
        {/* Tooltip */}
        <span className="absolute left-16 top-1/2 -translate-y-1/2 scale-0 transition-all rounded bg-zinc-900 p-2 text-xs text-white group-hover:scale-100 font-sans tracking-wide">
          Follow on Instagram
        </span>
      </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg transition-transform duration-300 hover:scale-110 active:scale-95 focus:outline-none"
        ...
        {/* Tooltip */}
        <span className="absolute right-16 top-1/2 -translate-y-1/2 scale-0 transition-all rounded bg-zinc-900 p-2 text-xs text-white group-hover:scale-100 font-sans tracking-wide">
          Chat on WhatsApp
        </span>
      </div>
    </>
